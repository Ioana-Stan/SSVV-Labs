...
public class XMLService {
    ...
    public XMLService(StudentXMLRepository studentXmlRepo, TemaXMLRepository temaXmlRepo, NotaXMLRepository notaXmlRepo) {
    ...
    public void createStudentFile(String idStudent, String idTema) {
        ...
        System.out.println(notaXmlRepo.findAll());
